...
namespace QuanLyTaiChinhCaNhan_Nhom06.Services
{
    public interface ITransactionService
    {
        ...
        Task<(bool Success, string Message)> UpdateTransactionAsync(int transactionId, decimal amount, string description, TransactionType type, int categoryId, DateTime date, int userId);
